            ...
            <div class="row align-items-center">
              <div class="col-md-6">
                <div class="title mb-30">
                  <h2>Listes de toutes les catégories</h2>
                </div>
              </div>
              <!-- end col -->
              <div class="col-md-6">
          ...
          <div class="row">
            ...
            <div class="col-lg-7">
              <div class="card-style mb-30">
                ...
                >
                  <div class="left">
                    <h6 class="text-medium mb-30">Catégorie</h6>
                  </div>
                  <div class="right">
                    <div class="select-style-1">
                      <div class="select-position select-sm">
                      ...
                      <tr>
                        <td>
                          <div class="product">
                            <div class="image">
                              <img
                                src="{{asset('asset/upload/categori/'.$cate->photo)}}"
                                alt=""
                              />
                            </div>
                            <p class="text-sm">{{$cate->libelle}}</p>
                          </div>
                        </td>
                       <!--<td>
                          <p class="text-sm"></p>
                        ...
                        <td>
                          <div class="action justify-content-end">
                            ...
                            >
                              <li class="dropdown-item">
                                <a href="{{url('del/'.$cate->id)}}" class="text-gray">Supprimer</a>
                              </li>
                              <li class="dropdown-item">
                                <a href="{{url('editc/'.$cate->id)}}" class="text-gray">Modifier</a>
                              </li>
                            </ul>
                          </div>
                        </td>
