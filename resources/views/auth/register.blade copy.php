            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="arron" class="col-md-4 col-form-label text-md-end">{{ __('Arrondissement') }}</label>
                        ...
                        <!--<div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="photo" type="file" class="form-control @error('quartier') is-invalid @enderror" name="photo" value="{{ old('profile_photo_path') }}" required autocomplete="quartier" autofocus>
                        ...
                        <div class="row mb-3">
                            <label for="prenom" class="col-md-4 col-form-label text-md-end">{{ __('Adresse') }}</label>
