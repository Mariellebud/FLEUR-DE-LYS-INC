...
<html lang="en">
  <head>
    ...
    <link
      ...
      type="image/x-icon"
    />
    <title>Ajout catégorie | BOUTIQUE</title>
              ...
              <div class="auth-cover-wrapper bg-primary-100">
                <div class="auth-cover">
                  <div class="title text-center">
                    ...
                    <p class="text-medium">
                        Remplissez le formulaire afin de modifier la catégorie dans votre boutique
                    </p>
                  </div>
            ...
            <div class="col-lg-6">
              <div class="signin-wrapper">
                <div class="form-wrapper">
                  <h6 class="mb-15">Formulaire de modification</h6>
                  <p class="text-sm mb-25">
                    
                  </p>
                  <form method="POST" action="{{url('update-cate/'.$cat->id)}}" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
                    ...
                    <div class="row">
                      ...
                      <div class="col-12">
                        <div class="input-style-1">
                          ...
                          <input type="text" name="libelle" value="{{$cat->libelle}}" placeholder="Nom produit" />
                        </div>
                      </div>
                      <!-- end col -->
                      ...
                      <!--<div class="col-12">
                        <div class="input-style-1">
                         ...
                         <textarea placeholder="Description" name="desc" rows="5"></textarea>
                        </div>
                      </div>
                       end col ->
                      <!- end col ->
                      ...
                      <div class="col-12">
                        ...
                        <p class="form-row form-row-last">
                            @if($cat->photo)
                                 <img src="{{ asset('asset/upload/categori/'.$cat->photo)}}" alt="" height="100" width="100">
                            @endif
                         <label>Photo</label>
                         <input type="file" id="password" name="photo">
                        </div>
                      </div>
