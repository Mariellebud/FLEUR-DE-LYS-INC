                    ...
                    <div class="user-menu">
                        ...
                        <!!@if (Route::has('login'))
                            @auth
                                ...
                                <li><a href="{{ route('admin.dashboard') }}"><i class="fa fa-user"></i> Mon panier ({{Auth:: user()->name}})</a></li>
                                <li>
                                ...
                                @else
                                <li><a href="{{ route('user.dashboard') }}"><i class="fa fa-user"></i> Mon panier ({{Auth:: user()->name}}) </a>
                ...
                <div class="col-md-12">
                    <div class="latest-product">
                        ...
                        <div class="product-carousel">
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img src="{{url('commerce/img/product-2.jpg')}}" alt="">
                                    <div class="product-hover">
                                        <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i>Acheter</a>
                                        <a href="single-product.html" class="view-details-link"><i class="fa fa-link"></i> Plus d'info</a>
                                    </div>
                                ...
                                <div class="product-carousel-price">
                                    <ins>$5000.00</ins> <del>$25.000</del>
                                </div> 
                            </div>
                            <div class="single-product">
                                <div class="product-f-image">
