              ...
              <div class="auth-cover-wrapper bg-primary-100">
                <div class="auth-cover">
                  <div class="title text-center">
                    ...
                    <p class="text-medium">
                        Remplissez le formulaire afin d'ajouter une nouvelle catégorie dans votre boutique
                    </p>
                  </div>
            ...
            <div class="col-lg-6">
              <div class="signin-wrapper">
                <div class="form-wrapper">
                  ...
                  <form method="POST" action="{{url('insert-cat')}}" enctype="multipart/form-data">
                  @csrf
                    <div class="row">
                      ...
                      <div class="col-12">
                        <div class="input-style-1">
                          ...
                          <input type="text" name="libelle" placeholder="Nom de catégorie" />
                        </div>
                      </div>
                      <!-- end col -->
