            ...
            <div class="col-lg-5 col-md-5 col-6">
              <div class="header-left d-flex align-items-center">
               ...
               <div class="header-search d-none d-md-flex">-->
                  <form action="#">
                    <input type="search" name="search" value="{{$search}}" placeholder="Recherche..." />
           ...
           <!-- <div class="col-lg-5">
            ...
            <div class="col-lg-7">
              <div class="card-style mb-30">
                ...
                >
                  <div class="left">
                    <h6 class="text-medium mb-30">Produit à vendre</h6>
                  </div>
                  <div class="right">
                    <div class="select-style-1">
                      <div class="select-position select-sm">
                        <select class="light-bg">
                          <option value="1"><a href="{{url('add_cat')}}" class="text-gray">Ajouter un produit</a></option>
                          <!--<option value="">Yesterday</option>-->
                        </select>
                      </div>
                    </div>
                ...
                <div class="table-responsive">
                  <table class="table top-selling-table">
                    <thead>
                      <tr>
                        <th>
                          <h6 class="text-sm text-medium">Produits</h6>
                        </th>
                        <th class="min-width">
                          <h6 class="text-sm text-medium">
                            Category <i class="lni lni-arrows-vertical"></i>
                        ...
                        <th class="min-width">
                          <h6 class="text-sm text-medium">
                            Prix <i class="lni lni-arrows-vertical"></i>
                          </h6>
                        </th>
                        <th class="min-width">
                          <h6 class="text-sm text-medium">
                            quantité <i class="lni lni-arrows-vertical"></i>
                          </h6>
                        </th>
                        <th>
                          <h6 class="text-sm text-medium text-end">
                      ...
                      <tr>
                        <td>
                          <div class="product">
                            <div class="image">
                              <img
                                src="{{asset('asset/upload/category/'.$pro->photo)}}"
                                alt=""
                              />
                            </div>
                            <p class="text-sm">{{$pro->libellep}}</p>
                          </div>
                        </td>
                        <td>
                          <p class="text-sm">{{isset($pro->category)?$pro->category->libelle:''}}
                          
                          </p>
                        </td>
                        
                        <td>
                          <p class="text-sm">{{$pro->prix}}</p>
                        </td>
                        <td>
                          <p class="text-sm">{{$pro->qte}}</p>
                        </td>
                        <td>
                          <div class="action justify-content-end">
                            <button class="edit">
                            ...
                            >
                              <li class="dropdown-item"> 
                                <a onclick="confirmation(event)" href="{{url('delete-category/'.$pro->id)}}" class="text-gray">Supprimer</a>
                              </li>
                              <li class="dropdown-item">
                                <a  href="{{url('editp/'.$pro->id)}}" class="text-gray">Modifier</a>
                              </li>
                            </ul>
                          </div>
                        </td>
    ...
    <script>
      function confirmation(ev){
        ...
        Swal({
          ...
          text:"Le fichier sera supprimer",
          icon:"warning",
          buttons:true,
          dangerMode:true,
        })
