                ...
                <div class="col-lg-9">
                    <div class="hero__search">
                        ...
                        <form action="" method="">
                                ...
                                <input type="search" name="search" value="{{$search}}" placeholder="Quelle catégorie voulez vous rechercher">
                        ...
                        <div class="hero__item set-bg" data-setbg="{{url('shop/img/robe-africaine.jpg')}}">
                            <div class="hero__text">
                                <span>Produit Originaux</span>
                                 <h2>Qualité <br />100% </h2>
                                 <p>Disponible et livrable</p>
                                <a href="#" class="primary-btn">VISITER</a>
                            </div>
                        </div>
