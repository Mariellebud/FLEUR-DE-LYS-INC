        ...
        <ul>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_5" class="collapse dropdown-nav">
              <li>
                <a href="{{url('clothes')}}"> Tableau des articles </a>
              </li>
              <li>
                <a href="{{url('add_cat')}}"> Ajout de produit </a>
              </li>
              <li>
                <a href="{{url('catego')}}"> Ajout de categori </a>
              </li>
              <li>
                <a href="{{url('categ')}}"> voir la categori </a>
              </li>
            </ul>
