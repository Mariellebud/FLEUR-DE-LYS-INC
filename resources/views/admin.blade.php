                ...
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            ...
                            <li><a href="{{url('clothes')}}"><i class="fa fa-heart"></i> Boutique</a></li>
                            <li><a href="{{url('add_cat')}}"><i class="fa fa-user"></i> Ajout de nouveau <article></article></a></li>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="shopping-item">
                        <a href="cart.html">Panier d'achat - <span class="cart-amunt">FCFA 12.000</span> <i class="fa fa-shopping-cart"></i> <span class="product-count">5</span></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="single-shop-product">
                        ...
                        <div class="product-carousel-price">
                            <ins></ins> <del>FCFA 999.00</del>
                        </div>  
                        
                        <div class="product-option-shop">
                            <a class="add_to_cart_button" data-quantity="1" data-product_sku="" data-product_id="70" rel="nofollow" href="/canvas/shop/?add-to-cart=70">Acheter</a>
                        </div>                       
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="single-shop-product">
                        <div class="product-upper">
                            <img src="{{ url('commerce/img/product-1.jpg')}}" alt="">
                        </div>
