...
<html lang="en">
  <head>
    ...
    <link
      rel="shortcut icon"
      href="{{ url('home/assets/img/fdl1.png')}}"
      type="image/x-icon"
    />
    <title>Ajout produit | BOUTIQUE</title>

    <!-- ========== All CSS files linkup ========= -->
    <link rel="stylesheet" href="{{ url('admin/assets/css/bootstrap.min.css')}}" />
    <link rel="stylesheet" href="{{ url('admin/assets/css/lineicons.css')}}" />
    <link rel="stylesheet" href="{{ url('admin/assets/css/materialdesignicons.min.css')}}" />
    <link rel="stylesheet" href="{{ url('admin/assets/css/fullcalendar.css')}}" />
    <link rel="stylesheet" href="{{ url('admin/assets/css/fullcalendar.css')}}" />
  ...
  <body>
    ...
    <aside class="sidebar-nav-wrapper">
      <div class="navbar-logo">
        <a href="index.html">
          <img src="{{ url('admin/assets/images/logo/fdla.png')}}" alt="logo" />
        </a>
      </div>
        ...
        <ul>
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_1" class="collapse  dropdown-nav">
              <li>
                <a href="{{url('/dashboard')}}" class=""> Ma boutique </a>
              </li>
            </ul>
          </li>
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_2" class="collapse dropdown-nav">
              <li>
                <a href="{{ URL::to('/ecommerce')}}"> FDL Market </a>
              </li>
              <!--<li>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_5" class="collapse show dropdown-nav">
              <li>
                <a href="{{url('clothes')}}"> Tous des articles </a>
              </li>
              <li>
                <a href="{{url('add_cat')}}"> Nouveau article </a>
              </li>
              <li>
                <a href="{{url('catego')}}"> Nouvelle de categorie </a>
              </li>
              <li>
                <a href="{{url('categ')}}"> Toutes les categories </a>
              </li>
            </ul>
          </li>
          <!--<li class="nav-item">
              ...
              <div class="header-right">
                ...
                <div class="profile-box ml-15">
                  ...
                  >
                    <li>
                      <a href="#0">
                        <i class="lni lni-user"></i> Modifier le Profile
                      </a>
                    </li>
                    <!--<li>
                      <a href="#0">
                ...
                <div class="breadcrumb-wrapper mb-30">
                  <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item"><a href="#0">Gestion</a></li>
              ...
              <div class="auth-cover-wrapper bg-primary-100">
                <div class="auth-cover">
                  <div class="title text-center">
                    <h1 class="text-primary mb-10">Bienvenu</h1>
                    <p class="text-medium">
                        Remplissez le formulaire afin de modifier un article dans votre boutique
                    </p>
                  </div>
                  <div class="cover-image">
                    <img src="{{ url('admin/assets/images/auth/signin-image.svg')}}" alt="" />
                  </div>
                  <div class="shape-image">
                    <img src="{{ url('admin/assets/images/auth/shape.svg')}}" alt="" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-6">
              <div class="signin-wrapper">
                <div class="form-wrapper">
                  <h6 class="mb-15">Formulaire de modification de produit</h6>
                  <p class="text-sm mb-25">
                    
                  </p>
                  <form method="POST" action="{{url('update-category/'.$produit->id)}}" enctype="multipart/form-data">
                  @csrf
                    @method('PUT')
                  <div class="row">
                  ...
                  <div class="select-style-1"> 
                    ...
                    <select class=" @error('cat') is-invalid @enderror" name="cat">
                      ...
                      <div class="col-12">
                        <div class="input-style-1">
                          ...
                          <input type="text" name="libp"  value="{{$produit->libellep}}" placeholder="Nom produit" />
                        </div>
                      </div>
                      <!-- end col -->
                      ...
                      <div class="col-12">
                        <div class="input-style-1">
                         ...
                         <textarea placeholder="Description"  value="{{$produit->description}}" name="desc" rows="5"></textarea>
                        </div>
                      </div>
                      <!-- end col -->
                      <!-- end col -->
                      <div class="col-12">
                        <div class="input-style-1">
                         <label>Prix</label>
                         <input type="text" name="prix" value="{{$produit->prix}}" placeholder="Prix" />
                        </div>
                      </div>
                      <!-- end col -->
                      <!-- end col -->
                      <div class="col-12">
                        <div class="input-style-1">
                         ...
                         <input type="text" name="qte" value="{{$produit->qte}}" placeholder="Quantité" />
                        </div>
                      </div>
                      <!-- end col -->
                      <div class="col-12">
                    ...
                    <tr>
                     <td>
                        ...
                        <p class="form-row form-row-last">
                            @if($produit->photo)
                                 <img src="{{ asset('asset/upload/category/'.$produit->photo)}}" alt="" height="100" width="100">
                            @endif
                         <label>Photo</label>
                         <input type="file" name="photo" placeholder="Quantité" />
                        </div>
                      </div>
                      <!-- end col -->
    ...
    <script src="{{ url('admin/assets/js/dynamic-pie-chart.js')}}"></script>
    <script src="{{ url('admin/assets/js/moment.min.js')}}"></script>
    <script src="{{ url('admin/assets/js/fullcalendar.js')}}"></script>
    <script src="{{ url('admin/assets/js/jvectormap.min.js')}}"></script>
    <script src="{{ url('admin/assets/js/world-merc.js')}}"></script>
    <script src="{{ url('admin/assets/js/polyfill.js')}}"></script>
