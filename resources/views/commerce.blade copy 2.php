                    ...
                    <div class="hero__search">
                        <div class="hero__search__form">
                            <form action="#">
                                ...
                                <input type="search" class="form-control typeahead" name="search" id="search_p" value="{{$search}}" placeholder="Quelle catégorie voulez vous rechercher">
                        ...
                        <div class="hero__item set-bg" data-setbg="{{url('shop/img/robe-africaine.jpg')}}">
                            <div class="hero__text">
                                <span>ROBES EN PAGNE</span>
                                 <h2>WAX <br />100% afrique</h2>
                                 <p>Disponible et livrable</p>
        ...
        <div class="container">
            <div class="row">
                ...
                @foreach($cat as $cate)
                    ...
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="{{asset('asset/upload/categori/'.$cate->photo)}}">
                            <h5><a href="{{url('voir_cat/'.$cate->libelle)}}">{{$cate->libelle}}</a></h5>
                        </div>
                    </div>
                    @endforeach
        ...
        <div class="row featured__filter">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix oranges fresh-meat">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="{{asset('asset/upload/category/'.$af->photo)}}">
                            <ul class="featured__item__pic__hover">
                                
                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="{{url('voir_detail/'.$af->libellep)}}"><i class="fa fa-shopping-cart"></i></a></li>
                            </ul>
                        </div>
                        <div class="featured__item__text">
                            <h6><a href="#">{{$af->libellep}}</a></h6>
                            <h5>{{$af->prix}} FCFA</h5>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="banner__pic">
                        <img src="{{url('shop/img/banner/banner-1.jpg')}}" alt="">
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="banner__pic">
                        <img src="{{url('shop/img/banner/banner-2.jpg')}}" alt="">
                    </div>
                </div>
            </div>
        </div>
