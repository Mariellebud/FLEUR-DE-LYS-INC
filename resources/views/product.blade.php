        ...
        <ul>
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_1" class="collapse  dropdown-nav">
              <li>
                <a href="index.html" class="active"> Ma boutique </a>
              </li>
            </ul>
          </li>
          <li class="nav-item nav-item-has-children">
              ...
              <div class="auth-cover-wrapper bg-primary-100">
                <div class="auth-cover">
                  <div class="title text-center">
                    ...
                    <p class="text-medium">
                        Remplissez le formulaire afin d'ajouter un nouveau produit dans votre boutique
                    </p>
                  </div>
                     ...
                     @enderror
                      ...
                      <div class="col-12">
                        <div class="input-style-1">
                          ...
                          <input type="text" class=" @error('libp') is-invalid @enderror" name="libp" placeholder="Nom produit" />
                          @error('Nom')
                         <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                         </span>
                      ...
                      <div class="col-12">
                        <div class="input-style-1">
                         ...
                         <textarea placeholder="Description" class=" @error('desc') is-invalid @enderror" name="desc" rows="5"></textarea>
                         @error('Description')
                         <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                         </span>
                      ...
                      <div class="col-12">
                        <div class="input-style-1">
                         <label>Prix</label>
                         <input type="text" name="prix" class=" @error('prix') is-invalid @enderror" placeholder="Prix" />
                         @error('Prix')
                         <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                         </span>
                      ...
                      <div class="col-12">
                        <div class="input-style-1">
                         ...
                         <input type="text" name="qte" class=" @error('qte') is-invalid @enderror" placeholder="Quantité" />
                         @error('Quantité')
                         <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                         </span>
                      ...
                      <div class="col-12">
                        <div class="input-style-1">
                         <label>Photo</label>
                         <input type="file" id="password" name="photo" class=" @error('photo') is-invalid @enderror">
                         @error('Photo')
                         <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                         </span>
